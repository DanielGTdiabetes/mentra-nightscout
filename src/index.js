    ...
    try{
      ...
      session.events?.onHeadPosition?.(async (data)=>{
        try{
          ...
          await this.animateTIRFill(session, sessionId, s, header, {tirPct}.tirPct, tLine, minMaxLine);
...
console.log("🚀 Nightscout MentraOS — build robusta");
